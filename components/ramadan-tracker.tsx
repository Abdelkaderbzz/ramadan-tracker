...
import { Calendar, BookOpen, BarChart3, Award, Compass, Sun, Moon, Bot } from "lucide-react"
...
export default function RamadanTracker() {
  ...
  const [currentDua, setCurrentDua] = useState("رب اغفر وارحم وأنت خير الراحمين")
    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      <div className="text-center mb-8 relative">
        <div className="absolute right-0 top-0 opacity-10">
          <div
            className="w-72 h-72 bg-contain bg-no-repeat bg-right"
        ...
        <motion.h1
          ...
          className="text-3xl md:text-4xl font-bold text-purple-800 mb-2 rtl"
        >
          يومي في رمضان
        </motion.h1>
        <motion.p
