...
export default function DailyTrackingTable() {
  const { activities, updateActivity, updateQuranCount, updateDhikr, calculateStats } = useRamadanStore()
  ...
  const handleInputChange = (day: number, field: "quran" | "dhikrMorning" | "dhikrEvening", value: string) => {
    if (field === "quran") {
            ...
            <table className="w-full border-collapse">
              ...
              <tbody>
                {currentItems.map((activity) => (
                  ...
                  >
                    <td className="p-3 text-right font-medium">{activity.day} رمضان</td>
                    <td className="p-3 text-center">
                      <Checkbox
                        checked={activity.fasting}
                        onCheckedChange={() => handleCheckboxChange(activity.day, "fasting")}
                    ...
                    <td className="p-3 text-center">
                      <Checkbox
                        ...
                        onCheckedChange={() => handleCheckboxChange(activity.day, "qiyam")}
                        className="mx-auto data-[state=checked]:bg-purple-600 data-[state=checked]:border-purple-600"
                      />
                    </td>
                    <td className="p-3 text-center">
                      <Checkbox
                        ...
                        onCheckedChange={() => handleCheckboxChange(activity.day, "duha")}
                        className="mx-auto data-[state=checked]:bg-purple-600 data-[state=checked]:border-purple-600"
                      />
                    </td>
                    <td className="p-3 text-center">
                      <Checkbox
                        ...
                        onCheckedChange={() => handleCheckboxChange(activity.day, "rawatib")}
                        className="mx-auto data-[state=checked]:bg-purple-600 data-[state=checked]:border-purple-600"
                      />
                    </td>
                    <td className="p-3 text-center">
                      <Input
                        ...
                        onChange={(e) => handleInputChange(activity.day, "quran", e.target.value)}
                        className="max-w-20 mx-auto text-center border-purple-200 focus:border-purple-400"
                      />
                    </td>
                    <td className="p-3 text-center">
                      <Checkbox
                        checked={activity.dhikrMorning !== "0" && activity.dhikrMorning !== ""}
                        onCheckedChange={(checked) =>
                          handleInputChange(activity.day, "dhikrMorning", checked ? "1" : "0")
                        }
                        className="mx-auto data-[state=checked]:bg-purple-600 data-[state=checked]:border-purple-600"
                      />
                    </td>
                    <td className="p-3 text-center">
                      <Checkbox
                        checked={activity.dhikrEvening !== "0" && activity.dhikrEvening !== ""}
                        onCheckedChange={(checked) =>
                          handleInputChange(activity.day, "dhikrEvening", checked ? "1" : "0")
                        }
                        className="mx-auto data-[state=checked]:bg-purple-600 data-[state=checked]:border-purple-600"
                      />
                    </td>
                    <td className="p-3 text-center">
                      <Checkbox
                        ...
                        onCheckedChange={() => handleCheckboxChange(activity.day, "charity")}
                        className="mx-auto data-[state=checked]:bg-purple-600 data-[state=checked]:border-purple-600"
                      />
                    </td>
                    <td className="p-3 text-center">
                      <Checkbox
                        ...
                        onCheckedChange={() => handleCheckboxChange(activity.day, "familyVisit")}
                        className="mx-auto data-[state=checked]:bg-purple-600 data-[state=checked]:border-purple-600"
                      />
                    </td>
                    <td className="p-3 text-center">
                      <Checkbox
                        ...
                        onCheckedChange={() => handleCheckboxChange(activity.day, "happiness")}
                        className="mx-auto data-[state=checked]:bg-purple-600 data-[state=checked]:border-purple-600"
                      />
                    </td>
                    <td className="p-3 text-center">
                      <Checkbox
                        ...
                        onCheckedChange={() => handleCheckboxChange(activity.day, "feeding")}
                        className="mx-auto data-[state=checked]:bg-purple-600 data-[state=checked]:border-purple-600"
                      />
                    </td>
                  </motion.tr>
