  ...
  'أدعية رمضان': [
    {
      ...
      translation:
        'O Allah, I am fasting, so accept it from me; indeed, You are the All-Hearing, the All-Knowing',
    ...
    },
    {
      ...
      translation:
        'O Allah, make me among those whom You free from the Fire in this noble month',
      reference: 'دعاء مأثور',
    },
    {
      arabic: 'اللهم بارك لنا في رمضان وبلغنا ليلة القدر',
      translation:
        'O Allah, bless us in Ramadan and enable us to reach the Night of Decree (Laylat al-Qadr)',
      reference: 'دعاء مأثور',
    },
    {
      ...
      <CardContent>
        ...
        {searchQuery ? (
          <div className='space-y-4'>
            <h3 className='text-lg font-medium'>{t('search_results')}</h3>
                    ...
                    <div>
                      ...
                      {dua.category && (
                        <span className='inline-block mt-2 text-xs bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300 px-2 py-1 rounded-full'>
                          {t(`categories.${categoryMapping[dua.category]}`)}
                        </span>
                      )}
                    </div>
